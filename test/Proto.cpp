...
void protobuf_AssignDesc_regs2_2eproto() {
  protobuf_AddDesc_regs2_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "regs2.proto");
  GOOGLE_CHECK(file != NULL);
  Separator_descriptor_ = file->message_type(0);
  static const int Separator_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Separator, size_),
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_regs2_2eproto);
}
...
void protobuf_AddDesc_regs2_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\013regs2.proto\022\tprotobufs\"\'\n\tSeparator\022\014\n"
    "\004size\030\001 \002(\r\022\014\n\004last\030\002 \002(\010\")\n\005State\022\017\n\007ad"
    "dress\030\001 \002(\r\022\017\n\007payload\030\002 \002(\r\"/\n\006Sample\022\020"
    "\n\010sequence\030\001 \002(\004\022\023\n\007payload\030\002 \003(\005B\002\020\001\"\033\n"
    "\nGetSamples\022\r\n\005count\030\001 \002(\r\"!\n\010GetState\022\025"
    "\n\taddresses\030\001 \003(\rB\002\020\001\",\n\010SetState\022 \n\006sta"
    "tes\030\001 \003(\0132\020.protobufs.State\"\016\n\014GetModelN"
    "ame\"\372\001\n\007Request\022\021\n\ttimestamp\030\001 \002(\004\022\r\n\005re"
    "qid\030\002 \002(\r\022\016\n\006module\030\003 \001(\r\022\025\n\006stream\030\004 \001("
    "\010:\005false\022)\n\ngetSamples\030\005 \001(\0132\025.protobufs"
    ".GetSamples\022%\n\010getState\030\006 \001(\0132\023.protobuf"
    "s.GetState\022%\n\010setState\030\007 \001(\0132\023.protobufs"
    ".SetState\022-\n\014getModelName\030\010 \001(\0132\027.protob"
    "ufs.GetModelName\"\250\001\n\010Response\022\021\n\ttimesta"
    "mp\030\001 \002(\004\022\r\n\005reqid\030\002 \002(\r\022\016\n\006module\030\003 \001(\r\022"
    " \n\006states\030\004 \003(\0132\020.protobufs.State\022\"\n\007sam"
    "ples\030\005 \003(\0132\021.protobufs.Sample\022\021\n\tmodelNa"
    "me\030\006 \001(\t\022\021\n\terror_msg\030\007 \001(\tB\"\n\025org.minds"
    "py.protobufsB\tProtobufs", 743);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "regs2.proto", &protobuf_RegisterTypes);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_regs2_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_regs2_2eproto {
  StaticDescriptorInitializer_regs2_2eproto() {
    protobuf_AddDesc_regs2_2eproto();
  }
} static_descriptor_initializer_regs2_2eproto_;

// ===================================================================

#ifndef _MSC_VER
const int Separator::kSizeFieldNumber;
...
const Separator& Separator::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_regs2_2eproto();
...
void Request::InitAsDefaultInstance() {
  getsamples_ = const_cast< ::protobufs::GetSamples*>(&::protobufs::GetSamples::default_instance());
  getstate_ = const_cast< ::protobufs::GetState*>(&::protobufs::GetState::default_instance());
  setstate_ = const_cast< ::protobufs::SetState*>(&::protobufs::SetState::default_instance());
  getmodelname_ = const_cast< ::protobufs::GetModelName*>(&::protobufs::GetModelName::default_instance());
}
...
void Request::MergeFrom(const Request& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_getsamples()) {
      mutable_getsamples()->::protobufs::GetSamples::MergeFrom(from.getsamples());
    }
    if (from.has_getstate()) {
      mutable_getstate()->::protobufs::GetState::MergeFrom(from.getstate());
    }
    if (from.has_setstate()) {
      mutable_setstate()->::protobufs::SetState::MergeFrom(from.setstate());
    }
    if (from.has_getmodelname()) {
      mutable_getmodelname()->::protobufs::GetModelName::MergeFrom(from.getmodelname());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}

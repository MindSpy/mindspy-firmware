...
void protobuf_AddDesc_regs_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\nregs.proto\"\'\n\tSeparator\022\014\n\004size\030\001 \002(\r\022"
    "\014\n\004last\030\002 \002(\010\")\n\005State\022\017\n\007address\030\001 \002(\r\022"
    "\017\n\007payload\030\002 \002(\r\"/\n\006Sample\022\020\n\010sequence\030\001"
    " \002(\004\022\023\n\007payload\030\002 \003(\005B\002\020\001\"\033\n\nGetSamples\022"
    "\r\n\005count\030\001 \002(\r\"!\n\010GetState\022\025\n\taddresses\030"
    "\001 \003(\rB\002\020\001\"\"\n\010SetState\022\026\n\006states\030\001 \003(\0132\006."
    "State\"\016\n\014GetModelName\"\322\001\n\007Request\022\021\n\ttim"
    "estamp\030\001 \002(\004\022\r\n\005reqid\030\002 \002(\r\022\016\n\006module\030\003 "
    "\001(\r\022\025\n\006stream\030\004 \001(\010:\005false\022\037\n\ngetSamples"
    "\030\005 \001(\0132\013.GetSamples\022\033\n\010getState\030\006 \001(\0132\t."
    "GetState\022\033\n\010setState\030\007 \001(\0132\t.SetState\022#\n"
    "\014getModelName\030\010 \001(\0132\r.GetModelName\"\224\001\n\010R"
    "esponse\022\021\n\ttimestamp\030\001 \002(\004\022\r\n\005reqid\030\002 \002("
    "\r\022\016\n\006module\030\003 \001(\r\022\026\n\006states\030\004 \003(\0132\006.Stat"
    "e\022\030\n\007samples\030\005 \003(\0132\007.Sample\022\021\n\tmodelName"
    "\030\006 \001(\t\022\021\n\terror_msg\030\007 \001(\tB\035\n\025org.mindspy"
    ".protobufsB\004Regs", 656);
...
void Request::InitAsDefaultInstance() {
  getsamples_ = const_cast< ::GetSamples*>(&::GetSamples::default_instance());
  getstate_ = const_cast< ::GetState*>(&::GetState::default_instance());
  setstate_ = const_cast< ::SetState*>(&::SetState::default_instance());
  getmodelname_ = const_cast< ::GetModelName*>(&::GetModelName::default_instance());
}
...
void Request::MergeFrom(const Request& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_getsamples()) {
      mutable_getsamples()->::GetSamples::MergeFrom(from.getsamples());
    }
    if (from.has_getstate()) {
      mutable_getstate()->::GetState::MergeFrom(from.getstate());
    }
    if (from.has_setstate()) {
      mutable_setstate()->::SetState::MergeFrom(from.setstate());
    }
    if (from.has_getmodelname()) {
      mutable_getmodelname()->::GetModelName::MergeFrom(from.getmodelname());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
